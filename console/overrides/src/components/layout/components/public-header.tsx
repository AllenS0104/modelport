        ...
        >
          ...
          >
            ...
            <div className='@container/system-brand flex min-w-0 flex-1 items-center gap-1 lg:min-w-36'>
              <Link
                to={homeUrl}
                reloadDocument={homeUrl.startsWith('/h5/')}
                className='group flex min-w-0 items-center gap-2.5'
              >
                <div className='flex flex-col gap-1'>
                  <PlatformBrand />
                  <div className='modelport-upstream'>
                    <div className='flex size-3 shrink-0 items-center justify-center'>
                      {logoContent}
                    </div>
                    <span className='max-w-48 truncate' title={displaySiteName}>
                      {loading ? (
                        <Skeleton className='h-4 w-16' />
                      ) : (
                        `Powered by ${displaySiteName}`
                      )}
                    </span>
                  </div>
                </div>
              ...
              {links.map((link) => {
                ...
                return (
                  <Link
                    key={`${link.title}:${link.href}`}
                    to={link.href}
                    reloadDocument={link.href.startsWith('/h5/')}
                    title={t(link.title)}
